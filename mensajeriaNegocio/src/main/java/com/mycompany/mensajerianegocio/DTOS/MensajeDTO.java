...
public class MensajeDTO {
     ...
     */
    public MensajeDTO(String texto, String fechaHoraRegistro, String imagenMensaje, int idUsuario, int idChat) {
        this.texto = texto;
     ...
     * @param imagenMensaje la URL de una imagen asociada al mensajeDTO
     */
    public MensajeDTO(int idMensaje, String texto, String fechaHoraRegistro, String imagenMensaje) {
        this.idMensaje = idMensaje;
        this.texto = texto;
        this.fechaHoraRegistro = fechaHoraRegistro;
        this.imagenMensaje = imagenMensaje;
