...
public class MensajeriaPersistencia {
    ...
    public static void main(String[] args) throws PersistenciaException {
        ...
        //Usuario usuario = new Usuario("5553458939", "contrasena123", "M", "2020-2-2", "imagen6.png".getBytes());
        //Usuario usuarioActualizado = new Usuario(9,"6442222222", "newpassword22222", "M", "2001-11-23", "perfil_Nuevo22222.jpg".getBytes());
